...
SKIP_PATHS=(
  ...
  '^README\.md$'                      # Top-level README with chainscan-linked production receipts
  '^FEEDBACK\.md$'                    # Builder feedback referencing real tx + skill hashes
  '^ARCHITECTURE\.md$'                # Architecture doc with on-chain example data
)
